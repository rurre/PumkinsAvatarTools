...
namespace Pumkin.Translations
{
    ...
    public class PumkinsLanguageHolder : ScriptableObject
    {
        public string languageName = "English";
        public string author = "Pumkin";
    ...
    public class CopierStrings
    {
        ...
        public string createMissing = "Create Missing";
        ...
        public string dynamicBones_createMissing = "Create Missing Bones";
    ...
    public class ThumbnailStrings
    {
        ...
        public string startUploadingFirst = "Start uploading an Avatar first";
    ...
    public class LogStrings
    {
        ...
        public string failedAlreadyHas = "Failed: {1} already has {0}";
    ...
    public class WarningStrings
    {
        ...
        public string vrcCamNotFound = "VRCCam not found";
    };
    ...
    {        
        ...
        public string jsonDotNetCredit = "JsonDotNet by Newtonsoft";
